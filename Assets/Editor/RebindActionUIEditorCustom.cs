...
public class RebindActionUIEditorCustom : UnityEditor.Editor
{
    ...
    /// </summary>
    [CustomEditor(typeof(RebindActionUICustom))]
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_PromptIconProperty = serializedObject.FindProperty("m_PromptIcon");
            m_ButtonProperty = serializedObject.FindProperty("m_Button");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_PromptIconProperty);
                EditorGUILayout.PropertyField(m_ButtonProperty);
        ...
        private SerializedProperty m_ButtonProperty;
        private SerializedProperty m_PromptIconProperty;
